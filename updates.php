...
<body>  
    ...
    <?php
            $myconn=mysqli_connect("localhost","root","","hubnet");
            if(isset($_POST['modify'])){
                ...
                $a=$_POST['doa'];
                $co=$_POST['course'];
                $q="update student set contact='$phone' where sid='$i'";
        ...
        <form action="" method="POST" id="for">
            ...
            <tr>
                ...
                <th><input type="text" name="doa" id="doa" class="th" placeholder="enter doa......"></th><br>
            </tr>
            <tr>
                <th>Course</th>
                <th><input type="text" name="fee" id="fee" class="th" placeholder="enter course....."></th><br>
            </tr>
            <tr>
                <input type="submit" name="modify" value="modify" id="modify" class="th">
            </tr>
            <!-- </table> -->
        </form>
