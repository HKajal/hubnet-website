...
<body>  
    ...
    <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $p=$_POST['phone'];
                $dj=$_POST['doj'];
                $q="insert into employee values('$i','$n','$p','$dj')";
                mysqli_query($mycon,$q);
            }
        ?>
        <form action="" method="POST" id="for" enctype="multipart/form-data">
            <center><h1>NEW EMPLOYEE</h1><hr></center>
            <tr>
                <th><label for="" class="lab" id="l1">Employee Id</label></th>
                <th><input type="text" name="eid" id="eid" class="th" placeholder="enter employee id...."></th><br>
            </tr>
            <tr>
            ...
            <tr>
                <th><label for="" class="lab" id="l4">Date of Join</label></th>
                <th><input type="text" name="doj" id="doj" class="th" placeholder="enter date of joining...."></th><br>
            </tr>
            <tr>
